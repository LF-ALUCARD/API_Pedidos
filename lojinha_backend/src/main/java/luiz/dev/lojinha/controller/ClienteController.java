...
import luiz.dev.lojinha.services.ClienteService;
...
public class ClienteController {
	...
	@PostMapping()
	public ResponseEntity<Cliente> insert(@RequestBody Cliente entidade){
		
		Cliente info = service.insert(entidade);
	...
	@PutMapping("{id}")
	public ResponseEntity<Cliente> update(@PathVariable Long id ,@RequestBody Cliente entidade){
